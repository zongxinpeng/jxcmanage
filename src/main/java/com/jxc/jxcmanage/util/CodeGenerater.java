...
public class CodeGenerater {
	...
	private String databaseName = "cicoding";
	private String tableName;
	private String modelName;
	private static VelocityEngine ve = new VelocityEngine();
	private File velocityOutdir = new File("d:\\cicoding生成代码\\cicoding\\src\\main\\java\\com\\du\\cicoding\\");
	 ...
	 * @param tableName 表名
	 */
	public CodeGenerater(String tableName) {
		super();
	...
	private void packageConfigInit() {
		...
		pc.setParent(null);
		pc.setEntity("com.cicoding.bean");
		pc.setMapper("com.cicoding.dao");
	...
	private void htmlGenterate() throws IOException {
		...
		// 首写字母大写
		vc.put("model1", getModelName());
		File file = new File("d:\\cicoding生成代码\\cicoding\\src\\main\\resources\\templates\\" + getTableName() + "page.html");
		CreateParents(file);
		FileWriter fw = new FileWriter(file);
		t.merge(vc, fw);
		fw.flush();
	...
	public void insertMenu(String tabelName , String menuName , String icon){
		...
		java.sql.PreparedStatement ps = null;
			try {
				Class.forName("com.mysql.jdbc.Driver");
				conn = DriverManager.getConnection(
						"jdbc:mysql://localhost:3306/cicoding?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull",
						"root", "123456");
